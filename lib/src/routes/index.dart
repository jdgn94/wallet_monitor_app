...
import 'package:wallet_monitor/src/pages/expenses_page.dart';
...
Map<String, WidgetBuilder> getApplicationRouters() {
  return <String, WidgetBuilder>{
    ...
    "/expenses": (BuildContext context) => const ExpensesPage(),
    "/currencies": (BuildContext context) => const CurrenciesPage(),
